...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-white border-t-4 border-double border-gray-300">
          ...
          >
            ...
            <ul className="space-y-2">
              {contactInfo.map((item) => (
                <li key={item.name} className="flex items-center text-gray-600 hover:text-[#4300FF] transition-all duration-200">
          ...
          >
            ...
            <form className="flex flex-col sm:flex-row items-center gap-2">
              <input
                ...
                className="w-full sm:w-auto px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#4300FF] focus:border-transparent transition-all duration-200"
              />
              <button
                type="submit"
                className="bg-gradient-to-r from-[#4300FF] to-[#00CAFF] text-white px-4 py-2 rounded-lg font-medium hover:from-[#00CAFF] hover:to-[#4300FF] transition-all duration-200 shadow hover:shadow-lg"
              >
                Subscribe
              </button>
            </form>
            ...
            <div className="flex space-x-4">
              {navigation.social.map((item, idx) => (
                <motion.a
                  ...
                  className="text-gray-400 hover:text-[#4300FF] transition-all duration-200"
                >
